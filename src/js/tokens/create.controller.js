(function () {
    ...
    var FIXED_ISSUE_FEE = new Money(50, Currency.Agate);
    ...
    function TokenCreateController($scope, $interval, constants, applicationContext, assetService,
        ...
        ctrl.wavesBalance = new Money(0, Currency.Agate);
        ...
        function refreshBalance() {
            apiService.address.balance(applicationContext.account.address)
                .then(function (response) {
                    ctrl.wavesBalance = Money.fromCoins(response.balance, Currency.Agate);
                });
        }
    }
