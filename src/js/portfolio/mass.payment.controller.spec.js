describe('Mass.Payment.Controller', function() {
    ...
    function initControllerAssets(assetBalance, wavesBalance) {
        ...
        if (!wavesBalance)
            wavesBalance = Money.fromTokens(20, Currency.Agate);

        var assetId;
        if (assetBalance.currency !== Currency.Agate) {
    ...
    it('should understand that waves are being sent', function () {
        initControllerAssets(Money.fromTokens(10, Currency.Agate), Money.fromTokens(10, Currency.Agate));
    ...
    it('should not confirm payment if there is not enough Waves when paying USD', function () {
        initControllerAssets(Money.fromTokens(1000, Currency.USD), Money.fromTokens(0.00399, Currency.Agate));
    ...
    it('should not confirm payment if there is not enough Waves when paying Waves', function () {
        var balance = Money.fromTokens(1000, Currency.Agate);
    ...
    it('should successfully submit payment is everything is ok', function () {
        ...
        expect(controller.confirm.fee.currency).toEqual(Currency.Agate);
